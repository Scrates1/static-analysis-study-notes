---
series_number: 3
title: "高校教学系列：程序分析——中间表示"
published_at: 2025-12-04T19:56:56+08:00
source_url: "https://mp.weixin.qq.com/s?__biz=MzU1NTc1NDMxMQ==&mid=2247484022&idx=1&sn=76fa95ff85549754bad3bc3a505b713f&chksm=fbce345eccb9bd4884e5b19e9ff19edfb697a5e69f5389b16b0f1f8eec0926d60686d7338b87"
msgid: 2247484022
itemidx: 1
image_count: 4
---
...
> HTML 证据：[本地正文结构视图](article.html) · [抓取原页](original.raw.html) · [公众号官方页面](https://mp.weixin.qq.com/s?__biz=MzU1NTc1NDMxMQ==&mid=2247484022&idx=1&sn=76fa95ff85549754bad3bc3a505b713f&chksm=fbce345eccb9bd4884e5b19e9ff19edfb697a5e69f5389b16b0f1f8eec0926d60686d7338b87)
...
其3AC的示例如下：
t1 = a + bt2 = t1 * ct3 = t2 < 10if t3 goto L1goto L2
L1: x = 1 goto Lend
L2: x = 2 goto Lend
Lend: y = x
...
将上述程序转化为SSA形式为：
t1_1 = a_0 + b_0t2_1 = t1_1 * c_0t3_1 = t2_1 < 10if t3_1 goto L1goto L2
L1: x_1 = 1 goto Lend
L2: x_2 = 2 goto Lend
Lend: x_3 = phi(x_1, L1, x_2, L2) y_1 = x_3
...
define i32 @f(i32 %a, i32 %b, i32 %c) {entry: %t1 = add i32 %a, %b %t2 = mul i32 %t1, %c %t3 = icmp slt i32 %t2, 10
br i1 %t3, label %then, label %else
then: %x_then = add i32 0, 1 br label %merge
else: %x_else = add i32 0, 2 br label %merge
merge: %x = phi i32 [%x_then, %then], [%x_else, %else] %y = add i32 %x, 0 ret i32 %y}
总结
三地址码（3AC）
