---
series_number: 5
title: "高校教学系列：程序分析—指针分析及抽象解释"
published_at: 2025-12-18T20:37:46+08:00
source_url: "https://mp.weixin.qq.com/s?__biz=MzU1NTc1NDMxMQ==&mid=2247484320&idx=1&sn=f306868888b67d001729ff18ef5abadc&chksm=fbce3588ccb9bc9e900831b3670b3bb609b078e7425c6fccc2b68366172997dafbd79ce8bf73"
msgid: 2247484320
itemidx: 1
image_count: 33
---
...
> HTML 证据：[本地正文结构视图](article.html) · [抓取原页](original.raw.html) · [公众号官方页面](https://mp.weixin.qq.com/s?__biz=MzU1NTc1NDMxMQ==&mid=2247484320&idx=1&sn=f306868888b67d001729ff18ef5abadc&chksm=fbce3588ccb9bc9e900831b3670b3bb609b078e7425c6fccc2b68366172997dafbd79ce8bf73)
...
示例：考虑如下代码片段
function f(x) { n = 1 //n是全局变量 if(x) { g(3) } else { n = 3 g(5) }}
function g(y){ //变量n在此处是否会等于y？ //codes ...}
...
示例：考虑如下代码片段
x = 0if(a > 0) x = 1else x = 2if(a > 0) x += 3#当程序运行到这里时，变量x是否会等于5？
...
x = {0,1}y = {1,2}
x ⊔ y = x | y # 并集，结果 {0,1,2}x ⊓ y = x & y # 交集，结果 {1}
